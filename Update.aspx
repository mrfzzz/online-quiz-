<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/masterpage.Master" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="projectdotnetquiz.Masterpage.Update" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contentpage" runat="server">
        ...
        <tr><td>&nbsp;</td>
            ...
            <td>&nbsp;<asp:TextBox id="txtbox_Id"  runat="server" OnTextChanged="txtbox_name_TextChanged" AutoPostBack="true"></asp:TextBox>
        ...
        <tr><td>&nbsp;</td>
            ...
            <td>&nbsp;<asp:TextBox ID="txtbox_Qna" runat="server" OnTextChanged="txtbox_name_TextChanged" AutoPostBack="true"></asp:TextBox>&nbsp;
        ...
        <tr><td>&nbsp;</td>
            ...
            <td>&nbsp;<asp:TextBox ID="txtbox_Ans" runat="server" OnTextChanged="txtbox_name_TextChanged" AutoPostBack="true"></asp:TextBox>&nbsp;
          ...
          <tr><td>&nbsp;</td>
            ...
            <td>&nbsp;<asp:TextBox ID="txtbox_Oa1" runat="server" OnTextChanged="txtbox_name_TextChanged" AutoPostBack="true"></asp:TextBox>&nbsp;
          ...
          <tr><td>&nbsp;</td>
            ...
            <td>&nbsp;<asp:TextBox ID="txtbox_Oa2" runat="server" OnTextChanged="txtbox_name_TextChanged" AutoPostBack="true"></asp:TextBox>&nbsp;
          ...
          <tr><td>&nbsp;</td>
            ...
            <td>&nbsp;<asp:TextBox ID="txtbox_Oa3" runat="server" OnTextChanged="txtbox_name_TextChanged" AutoPostBack="true"></asp:TextBox>&nbsp;
